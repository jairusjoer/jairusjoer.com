...
from: '2024'
to: Now
title: Full Stack Engineer with a very long quite unbelieavable title to display
...
[**GitHub - web-platform-tests/interop: web-platform-tests Interop project**](https://github.com/web-platform-tests/interop?ref=aggregata.de)

[**web-platform-tests Interop project. Contribute to web-platform-tests/interop development by creating an account on GitHub.**](https://github.com/web-platform-tests/interop?ref=aggregata.de)

[**GitHub**](https://github.com/web-platform-tests/interop?ref=aggregata.de)
...
[**GitHub - w3c/webextensions: Charter and administrivia for the WebExtensions Community Group (WECG)**](https://github.com/w3c/webextensions?ref=aggregata.de)

[**Charter and administrivia for the WebExtensions Community Group (WECG) - w3c/webextensions**](https://github.com/w3c/webextensions?ref=aggregata.de)

[**GitHub**](https://github.com/w3c/webextensions?ref=aggregata.de)
...
A prominent and widely recognized example, which we'll discuss in the next chapter, for advocating a native approach is dialogs and form validation - both of which are already available and [**fully supported in all major browsers as of March 2022**](https://caniuse.com/dialog?ref=aggregata.de).
...
[**\<dialog>: The Dialog element - HTML: HyperText Markup Language | MDN**](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog?ref=aggregata.de)

[**The \<dialog> HTML element represents a modal or non-modal dialog box or other interactive component, such as a dismissible alert, inspector, or subwindow.**](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog?ref=aggregata.de)

[**MDN Web Docs**](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/dialog?ref=aggregata.de)
...
[**Client-side form validation - Learn web development | MDN**](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Forms/Form_validation?ref=aggregata.de)

[**It is important to ensure all required form controls are filled out, in the correct format, before submitting user entered form data to the server. This client-side form validation helps ensure data entered matches the requirements set forth in the various form controls.**](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Forms/Form_validation?ref=aggregata.de)

[**MDN Web Docs**](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Forms/Form_validation?ref=aggregata.de)
...
While the focus automatically moves to the dialog element when it is opened, we can further enhance the placement of the focus by using the [**`autofocus`**](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/autofocus?ref=aggregata.de) attribute in an **`<input>`** element to allow immediate input without further navigation.

To verify that our form contains all the necessary and valid information, the **`type`** and **`required`** attributes come in handy. For a more granular approach, consider [**using built-in form validation**](https://developer.mozilla.org/en-US/docs/Learn_web_development/Extensions/Forms/Form_validation?ref=aggregata.de#using_built-in_form_validation) with advanced attributes such as \`pattern, which accepts regex.
