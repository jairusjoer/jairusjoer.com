---
title: 'Delightful Animations IV: Mind the Gap'
description: 'A concise, introspective note on design engineering: acknowledging the gap between discerning taste and consistent execution, then methodically narrowing it'
date: 2025-11-25
---

[In the last issue](https://www.notion.so/Issue-7-Intricacies-of-Interaction-Design-2b507bfc04d28029bd7ee9f7a31cacde?pvs=21), I briefly discussed Design Engineers and their dedication to their craft. In this issue, I’m expanding on that thread with filling my gaps in the field and what it means for me to own the craft end to end.

Although I often obsessed over polish, I didn’t consistently slow down to explore the full depth that great work demands. That shifted recently after reading “[_Developing Taste_](https://emilkowal.ski/ui/developing-taste)” by Emil Kowalski and, later, the updated material in his course, “[Animations on the Web](https://animations.dev/)”.
...
<video controls>
  <source src="/media/sidebar.mp4" type="video/mp4" />
</video>
...
As I continue to narrow the gap, I will study the aforementioned course and apply what I learn along the way. This includes everything from recording and refining to addressing ease of use and accessibility concerns, as well as [questioning the necessity of animations](https://emilkowal.ski/ui/you-dont-need-animations).
