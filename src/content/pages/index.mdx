...
>
  <Entry
    ...
    skills={['CakePHP','Codegen','Design Systems','Docker','ESLint','GraphQL','Jest','MySQL','Nuxt','PHP 8.3','PNPM','Playwright','Prettier','Rspack','Sentry','Storybook','Style Dictionary','Tailwind CSS','Temporal','TypeScript','Vitest','Vue.js','WCAG 2.1']}
  ...
  >
    ...
    - **Spearheaded design initiatives** as technical leader, establishing design system cohesion and creating optimized workflows
    ...
    - **Provided technical leadership** by authoring RFCs and pioneering adoption of modern technologies and practices
