...
>
  ...
  >
    ...
    - **Developed internal docs system** using Astro and MDX, streamlining workflows and creating reusable patterns
    - **Built campaign website** "Zusammen wächst Zukunft" for LBS with timed functionality and engaging UX
    - **Created transport info hub** for MOBILOTSIN with dynamic content management serving regional data
